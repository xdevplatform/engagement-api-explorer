...
class TwitterOAuth extends Config
{
     ...
     */
    public function oauth($url, array $parameters = [])
    {
        $response = [];
        $this->resetLastResponse();
     ...
     * @return array|object
     */
    public function oauth2($url, array $parameters = [])
    {
        $method = 'POST';
        $this->resetLastResponse();
        $this->response->setApiPath($path);
     ...
     * @return array|object
     */
    public function post($url, array $parameters = [], $json = false)
    {
        return $this->http('POST', $url, $parameters, $json);
    }
    ...
    {
        return $this->http('DELETE', $url, $parameters, false);
    }
    ...
    {
        return $this->http('PUT', $url, $parameters, false);
    }
     ...
     * @return array|object
     */
    public function upload($url, array $parameters = [], $chunked = false)
    {
        if ($chunked) {
            return $this->uploadMediaChunked($url, $parameters);
        } else {
            return $this->uploadMediaNotChunked($url, $parameters);
        }
    }
     ...
     * @return array|object
     */
    private function uploadMediaNotChunked($url, array $parameters)
    {
        ...
        return $this->http('POST', $url, $parameters, false);
    }
     ...
     * @return array|object
     */
    private function uploadMediaChunked($url, array $parameters)
    {
        $init = $this->http('POST', $url, $this->mediaInitParameters($parameters), false);
        // Append
        $segmentIndex = 0;
     ...
     * @return array|object
     */
    private function http($method, $url, array $parameters, $json = null)
    {
        $this->resetLastResponse();
